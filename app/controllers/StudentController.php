  ...
  class StudentController extends Controller
    ...
    function login() {
      ...
      $this->validate(($entry = $MStudent->get($email)) != NULL,
        $err, 'not registered<br><small><a href="../employers/login">Are you trying to log in as a recruiter?</a></small>');
      ...
      if ($this->isValid()) {
        if (!isset($entry['pass'])) {
          ...
          $this->validate($MStudent->login($email, $pass),
            $err, 'invalid credentials <br><small><a href="../employers/login">Are you trying to log in as a recruiter?</a></small>');

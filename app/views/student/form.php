<panel class="form">
  <div class="content">
    ...
    <form method="post">
      ...
      <div class="form-slider"><label for="class">Class Year</label><input type="text" id="class" name="class" value="<?php View::echof('class'); ?>" /></div>
      <div class="form-slider"><label for="school">School</label><input type="text" id="name" name="school" value="<?php View::echof('school'); ?>" /></div>
      ...
      <label><input class="internship" onchange="lookingForValueChanged()" type="checkbox" id="internship" name="internship" value="<?php View::echof('internship'); ?>" <?php View::checked('lookingFor', 'internship'); ?> />Internship </label>
      <label><input class="fulltime" onchange="lookingForValueChanged()" type="checkbox" id="fulltime" name="fulltime" value="<?php View::echof('fulltime'); ?>" <?php View::checked('lookingFor', 'fulltime'); ?> />Full-Time </label>
      <label><input class="housing" onchange="lookingForValueChanged()" type="checkbox" id="housing" name="housing" value="<?php View::echof('housing'); ?>" <?php View::checked('lookingFor', 'housing'); ?> />Housing </label>
      <br>
      ...
      <div class="form-slider"><label for="bio" class="fortextarea">About yourself: (max. 1000 characters)*</label><textarea id="bio" name="bio" maxlength="1000"><?php View::echof('bio'); ?></textarea></div>

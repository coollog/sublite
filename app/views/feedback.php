<panel class="form">
  <div class="content">
    ...
    <form method="post">
      <?php View::notice(); ?>
      <div class="form-slider"><label for="name">Name</label><input type="text" id="name" name="name" value="<?php View::echof('Lname'); ?>" required /></div>
      <div class="form-slider"><label for="email">Email</label><input type="email" id="email" name="email" value="<?php View::echof('Lemail'); ?>" required /></div>
      <br />
      <left>Please describe the bug (what you did, what the bug was, what were you trying to do) or write your feedback:</left>
      <div class="form-slider"><textarea id="feedback" name="feedback" required><?php View::echof('feedback'); ?></textarea></div>
      <br>

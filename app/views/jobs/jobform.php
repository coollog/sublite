...
<panel class="form">
  <div class="content">
    ...
    <form method="post">
      ...
      <div class="form-slider"><label for="salary">Compensation($):</label><input type="text" id="salary" name="salary" required maxlength="100" value="<?php vecho('salary'); ?>" required /></div>
      <right>

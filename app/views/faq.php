...
<panel class="faq">
  <div class="content">
    ...
    <left>
      <headline class="small">Students - Internships</headline>
      ...
      <br /> <br /> <br />
      <headline class="small">Students - Housing</headline>

      <subheadline>Who can create SubLite accounts?</subheadline>

      Any student at any accredited university.

      <subheadline>What if I have a problem with my account?</subheadline>

      Contact <a href="mailto: info@sublite.net">info@sublite.net</a> for any issues regarding usage of the website, including Log In and password issues.
      ...
      <br />
      Legitimate reasons to contact another user are to ask questions about the amenities and to inquire about price. Please contact hosts in good-faith. Spamming is expressly prohibited. For more guidance, refer to our <a href="<?php vecho('dirpre'); ?>../terms.php">Terms of Use</a>.
      ...
      <br />
      For more information, read our <a href="<?php vecho('dirpre'); ?>../privacy.php">Privacy Policy</a>.

      <subheadline>Where can I leave feedback?</subheadline>

      Whether you like our website or not, we want to hear what you have to say. If you have a funny or horrific summer housing experience, we also want to hear from you. Email us at <a href="mailto: info@sublite.net">info@sublite.net</a>.

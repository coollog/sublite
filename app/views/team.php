...
<panel class="team">
  <div class="content">
    ...
    <br />
    <div class= "memberbox">
      <img class= "memberimage" src="<?php echo $GLOBALS['dirpre']; ?>assets/gfx/headshots/alisa.jpg" />
      
      <p class="membername">Alisa Melekhina</p>
      <p class="memberposition">Co-Founder, University of Pennsylvania Law School</p>
      <p class="memberbio">Alisa graduated with her Juris Doctor from the University of Pennsylvania Law School in May 2014 and also completed a Certificate in Business Economics and Public Policy at Wharton Business School. She is currently working at a corporate law firm in NYC in the fields of intellectual property and white-collar litigation.
      <br />
